              ...
              >
                ...
                <div className="p-6">
                  ...
                  <div className="mt-6 grid grid-cols-2 gap-2">
                    <a href="tel:+254711856795" className="inline-flex items-center justify-center gap-2 rounded-full bg-charcoal px-4 py-2.5 text-xs font-semibold text-cream transition-colors hover:bg-honey-dark">
                      <Phone className="h-3.5 w-3.5" /> Enquire
                    </a>
                    <a target="_blank" rel="noreferrer" href={waMsg(p.title)} className="inline-flex items-center justify-center gap-2 rounded-full border border-border bg-card px-4 py-2.5 text-xs font-semibold text-charcoal transition-colors hover:bg-secondary">
