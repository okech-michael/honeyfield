...
export const Route = createFileRoute("/contact")({
  head: () => ({
    meta: [
      { title: "Contact Ntarakwai pure & Natural Honey" },
      { name: "description", content: "Get in touch with Ntarakwai pure & Natural Honey for orders, wholesale enquiries and partnerships. Call 0711856795." },
      { property: "og:title", content: "Contact Ntarakwai pure & Natural Honey" },
      ...
      <section className="bg-background py-20">
        <div className="container-luxe grid gap-10 lg:grid-cols-[1fr_1.2fr]">
          <div className="reveal space-y-5">
            {[
              { icon: Phone, t: "Phone", v: "0711856795", href: "tel:+254711856795" },
              { icon: Mail, t: "Email", v: "ntarakwai2023@gmail.com", href: "mailto:ntarakwai2023@gmail.com" },
              { icon: MapPin, t: "Address", v: "MT. KULAL" },
